...
const firebaseConfig = {
  apiKey: "AIzaSyC2869X5Dh9ajpIZUkWlDQcdhPK_dfz2Wo",
  authDomain: "links-48cec.firebaseapp.com",
  projectId: "links-48cec",
  appId: "1:319182700025:web:f9b0d069faac7a22a11128"
};
...
loginButton.addEventListener("click", (e) => {
  ...
  setPersistence(auth, browserSessionPersistence)
    ...
    .then((userCredential) => {
      ...
      const expirationTime = new Date().getTime() + 8 * 60 * 60 * 1000; // 8 uur
